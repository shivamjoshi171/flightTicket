...
<div class="container">
<div class="row">
<div class="col-lg-12 tableEd">
<div class="row">
<div class="col-lg-12">
<h3>Flight Details</h3>
</div>
<form action="/addFlightToAir" method="post">
<table class="table">
	...
	<c:forEach var="listValue" items="${flightList}">
		<tr>
			...
			<td><input type="checkbox" value="${listValue.getFlightId() }" name="flights"></td>
		</tr>
	</c:forEach>
</table>
<input type="submit" class="btn btn-primary btn-block" value="Add Flights">
</form>
</div>
